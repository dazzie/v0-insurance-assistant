...
exports.instanceOfPipelineListSummary = instanceOfPipelineListSummary;
exports.PipelineListSummaryFromJSON = PipelineListSummaryFromJSON;
exports.PipelineListSummaryFromJSONTyped = PipelineListSummaryFromJSONTyped;
exports.PipelineListSummaryToJSON = PipelineListSummaryToJSON;
exports.PipelineListSummaryToJSONTyped = PipelineListSummaryToJSONTyped;
/**
 * Check if a given object implements the PipelineListSummary interface.
 */
function instanceOfPipelineListSummary(value) {
...
function PipelineListSummaryFromJSON(json) {
    return PipelineListSummaryFromJSONTyped(json, false);
}
function PipelineListSummaryFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PipelineListSummaryToJSON(json) {
    return PipelineListSummaryToJSONTyped(json, false);
}
function PipelineListSummaryToJSONTyped(value, ignoreDiscriminator) {
